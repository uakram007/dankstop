...
hsjs.halo = function ($) {
    ...
    var ella = {
                ...
                if (self.attr('disabled') !== "disabled") {
                    ...
                    switch (window.ajax_cart) {
                        ...
                        case "normal":
                            ...
                            ella.doAjaxAddToCartNormal(variant_id, quantity, title, image);
                            break;

                        case "upsell":
                            ella.doAjaxAddToCart(variant_id, quantity, handle);
                            break;
                    };
        ...
        doAjaxAddToCartNormal: function(variant_id, quantity, title, image) {
            $.ajax({
                type: "POST",
                url: "/cart/add.js",
                data: 'quantity=' + quantity + '&id=' + variant_id,
